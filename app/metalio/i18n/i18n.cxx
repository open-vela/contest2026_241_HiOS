 ...
 *
 * i18n implementation — ported from MetalioClaw4 main/i18n/i18n.cc.
 * Replaces esp_log.h with esp_log_shim.h, settings.h with NuttX Settings.
 */
...
void Init()
{
    ...
    const std::string code =
        s.GetString(kKeyLocale,
                    kLocaleInfos[static_cast<size_t>(kDefaultLocale)].code);
