 ...
 *
 * CircularStrip — ported from MetalioClaw4 main/led/circular_strip.h.
 *
 * Drives a ring of WS2812 addressable LEDs.  The ESP-IDF led_strip RMT
 * driver is replaced by the nuttx_led_strip.h stub; the rest of the
 * logic (state → pattern mapping, blink / breathe / scroll / fade-out
