 ...
 *
 * SingleLed implementation — ported from MetalioClaw4 main/led/single_led.cc.
 *
 * Only the LED-strip driver include is swapped (ESP-IDF led_strip.h →
 * nuttx_led_strip.h).  The state machine and blink timer logic are
 * preserved verbatim so the user-visible LED behaviour matches the
 * upstream firmware.
 */
...
SingleLed::SingleLed(gpio_num_t gpio)
{
    ...
    blink_timer_args.name = "blink_timer";
