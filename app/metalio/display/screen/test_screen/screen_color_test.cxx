 ...
 *
 * ScreenColorTest — ported from MetalioClaw4
 * main/display/screen/test_screen/screen_color_test.cc.
 *
 * Full-screen solid/pattern test: tap to advance through white/black/red/
 * green/blue solids, 16-step gray, color bars, rainbow, interlace and gray
 * gradient; tapping the last pattern returns to the test menu.
 */
