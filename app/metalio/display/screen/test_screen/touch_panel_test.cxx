 ...
 * main/display/screen/test_screen/touch_panel_test.cc.
 *
 * Phase 1 places 5 random orange targets; tapping each advances to the next.
 * After 5 hits it enters a full-screen paint phase to check for touch dead
 * zones; a bottom "done" button returns to the test menu.
 */
...
int RandomInRange(int lo, int hi) {
    ...
    return static_cast<int>(lv_rand(static_cast<uint32_t>(lo),
