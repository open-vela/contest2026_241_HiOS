...
/* Avoid name collision with NuttX <nuttx/fs/fs.h> internal helpers
 * (file_open / file_read / file_seek / file_close) which have different
 * signatures.  Rename the local static helpers via macros. */
#define file_open   hls_ioh_file_open
#define file_read   hls_ioh_file_read
#define file_seek   hls_ioh_file_seek
#define file_close  hls_ioh_file_close
